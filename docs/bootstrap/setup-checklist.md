...
## Identity & code
- [ ] `bootstrap.config.json` filled; `npm run rebrand -- --apply` run; diff reviewed
...
- [ ] Custom domain + DNS cutover plan; `astro.config.mjs` site URL + `public/robots.txt` sitemap URL correct
