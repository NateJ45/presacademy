...
// =============================================================================
// Ported from the WCP site, 2026-08-28. This file is repo-agnostic: it names no
// route, no Worker and no schema, and every caller passes its own scriptName.
// It carries NO canonical marker yet, because the starter
// (ncs-astro-sanity-starter) does not have it. When the starter adopts it, add
// the PORTABLE marker line to all three copies in the same sync session.
//
...
// keeps US time (behind UTC), so a "day" here starts in the late evening
