...
ico.writeUInt16LE(1, 4); // header: reserved, type=icon, count=1
ico.writeUInt8(0, 6);
ico.writeUInt8(0, 7); // width/height 0 => 256
ico.writeUInt16LE(1, 10);
ico.writeUInt16LE(32, 12); // planes, bpp
ico.writeUInt32LE(icoPng.length, 14);
ico.writeUInt32LE(22, 18); // size, offset
